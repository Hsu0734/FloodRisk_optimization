...
# 循环读取每个文件，并累加
for n in range(50):
    filename = f'DEM_sink_DEM5m_{n}.tif'
...
wbe.write_raster(average_raster, 'DEM_sink_DEM5m_average.tif', compress=True)

path_01 = f'../03_visualization/DEM_sink_DEM5m_average.tif'
data_01 = rs.open(path_01)

fig, ax = plt.subplots(figsize=(32, 32))
ax.tick_params(axis='both', which='major', labelsize=40)
show(data_01, title=f'DEM_sink_DEM5m_average', ax=ax)
