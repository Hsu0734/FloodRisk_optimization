...
# 循环读取每个文件，并累加
for n in range(50):
    filename = f'DEM_volume_5m_{n}.tif'
...
wbe.write_raster(average_raster, 'DEM_volume_5m_average.tif', compress=True)

path_01 = f'../03_visualization/DEM_volume_5m_average.tif'
