...
# 循环读取每个文件，并累加
for n in range(50):
    filename = f'DEM_solution_DEM10m_{n}.tif'
...
wbe.write_raster(average_raster, 'DEM_solution_DEM10m_average.tif', compress=True)

path_01 = f'../03_visualization/DEM_solution_DEM10m_average.tif'
data_01 = rs.open(path_01)

fig, ax = plt.subplots(figsize=(16, 16))
ax.tick_params(axis='both', which='major', labelsize=20)
show(data_01, title=f'DEM_solution_DEM10m_average', ax=ax)
