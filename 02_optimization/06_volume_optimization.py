"""
Multi-objective optimization: Sink volume optimization & earthwork
Author: Hanwen Xu
Version: 1
Date: June 29, 2024
"""
...
class MyProblem(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        sink_volume_function = volume_sum_calculation(x)

        out["F"] = [earth_volume_function, sink_volume_function]

def volume_sum_calculation(var_list):
    i = 0
...
wbe.write_raster(min_flow_length_dem, file_name='min_sink_volume_solution', compress=True)
...
wbe.write_raster(after_dem_minFL, file_name='min_sink_volume_dem', compress=True)
